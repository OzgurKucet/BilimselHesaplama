...
** n * n tane karekteri matrise atayan bir fonksiyon yazınız
* kendisine aktarılan bir kelimeyi bu matris üzerinde soldan sağa - sağdan 
*sola - yukarından aşşağıya - aşşağıdan yukarıya - doğrultularında arayıp olup 
*olmadığını return eden bir fonksiyon yazınız.
